...
/**
 * IMMEDIATE AUTH CONTROLLER
 * 
 * A simple authentication controller that shows notifications immediately.
 */
class ImmediateAuthController extends Controller
{
    ...
    public function register()
    {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            // If it's a redirect, we need to handle it differently
            if ($result instanceof \CodeIgniter\HTTP\RedirectResponse) {
                return $result;
            }
            
            // If it's data, merge it
            if (is_array($result)) {
        ...
        return view('immediate_register', $data);
    }
     ...
     * 
     * @return array|RedirectResponse Registration result or redirect
     */
